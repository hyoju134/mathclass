...
import { BookOpen, CheckCircle, ChevronRight, Layers, Lightbulb, Play, ArrowLeft, Sparkles } from "lucide-react";
...
const VISANG_GRADE2_UNITS: Unit[] = [
  {
    ...
    activities: [
      { name: "순환소수의 분수 변환 계산기", type: "개념정리", desc: "순환마디를 찾아 분수로 바꾸는 수리 과정을 탐구합니다." },
      { name: "지수법칙 마스터 퀴즈", type: "문제풀이", desc: "곱셈, 나눗셈, 거듭제곱의 지수 계산을 빠르게 맞춰보세요." },
      { name: "다항식의 덧셈과 뺄셈 훈련", type: "활동지", desc: "동류항끼리 모아 식을 단순화하는 시각적 훈련을 진행합니다." },
    ],
  },
  {
    id: 2,
    ...
    activities: [
      { name: "일차부등식 영역과 수직선 탐구", type: "개념정리", desc: "부등호의 방향이 바뀌는 조건을 수직선 상에서 확인합니다." },
      { name: "가감법 vs 대입법 챌린지", type: "문제풀이", desc: "연립방정식을 가장 효율적인 방법으로 해결해봅니다." },
      { name: "실생활 연립방정식 활용 문제", type: "활동지", desc: "거리·속력·시간 문제와 농도 문제를 방정식으로 세워봅니다." },
    ],
  },
  {
    id: 3,
    ...
    activities: [
      { name: "기울기와 y절편 시뮬레이터", type: "개념정리", desc: "a와 b의 값 변화에 따라 직선이 어떻게 움직이는지 관찰합니다." },
      { name: "두 직선의 교점과 연립방정식", type: "문제풀이", desc: "그래프의 교점이 곧 연립방정식의 해임을 직관적으로 이해합니다." },
    ],
  },
  {
    id: 4,
    ...
    activities: [
      { name: "외심과 내심의 위치 찾기", type: "개념정리", desc: "예각·직각·둔각삼각형의 외심과 내심 위치 차이를 발견합니다." },
      { name: "평행사변형이 되는 조건 퀴즈", type: "문제풀이", desc: "여러 사각형 중 평행사변형의 조건을 만족하는지 판별합니다." },
    ],
  },
  {
    id: 5,
    ...
    activities: [
      { name: "닮음비와 넓이·부피의 비 탐구", type: "개념정리", desc: "닮음비 m:n 일 때 넓이의 비 m²:n²의 관계를 알아봅니다." },
      { name: "피타고라스 정리 변 길이 계산기", type: "문제풀이", desc: "직각삼각형의 두 변을 알고 나머지 한 변의 길이를 계산합니다." },
    ],
  },
  {
    id: 6,
    ...
    activities: [
      { name: "경우의 수 (합의 법칙 & 곱의 법칙)", type: "개념정리", desc: "동시 일어나는 경우와 따로 일어나는 경우의 차이를 학습합니다." },
      { name: "적어도 하나는 ~일 확률 구하기", type: "문제풀이", desc: "여사건의 확률을 활용하여 복잡한 확률 문제를 쉽게 풀어봅니다." },
    ],
  },
];
    ...
    <div className="max-w-5xl mx-auto space-y-10 animate-in fade-in duration-700">
      ...
      <div className="text-center space-y-3">
        ...
        <p className="text-gray-500 font-medium text-sm md:text-base">
          비상 교과서 단원별 핵심 개념과 직관적인 학습 활동을 선택하여 공부하세요!
        </p>
      </div>
